...
// PokéAPI project (https://pokeapi.co/docs/v2).
//
// The Client also supports custom caching strategies - or cache.None if you
// intend on implementing your own. Under PokéAPI's Fair Use Policy
...
// PokéAPI's own docs - with some edits to allow go doc to link between
